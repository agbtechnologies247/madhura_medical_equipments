...
const product = {
  ...
  description: "DreamStation 2 Advanced is the next evolution in clinically proven, integrated sleep solutions. It's designed to provide operational efficiencies and a simplified user experience, including flexible setup, a fully integrated humidifier and modem.",
  features: [
    "Color touchscreen for easy setup and navigation",
    "Integrated heated humidifier",
    "Ramp Plus feature for a comfortable start",
    "29% smaller and 32.5% lighter than original DreamStation",
    "Daily feedback on therapy progress"
  ]
};

export default function DreamStation2Page() {
  return (
